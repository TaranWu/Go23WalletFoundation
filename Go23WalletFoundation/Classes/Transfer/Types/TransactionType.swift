...
extension TransactionType {
    public enum Configuration {
        case tokenScriptTransaction(confirmType: ConfirmType, contract: Go23Wallet.Address, functionCallMetaData: DecodedFunctionCall)
    ...
    public func buildSendNativeCryptocurrency(recipient: Go23Wallet.Address, amount: BigUInt) throws -> UnconfirmedTransaction {
        switch self {
    ...
    public func buildSendErc20Token(recipient: Go23Wallet.Address, amount: BigUInt) throws -> UnconfirmedTransaction {
    ...
    public func buildSendErc1155Token(recipient: Go23Wallet.Address, account: Go23Wallet.Address) throws -> UnconfirmedTransaction {
    ...
    public func buildSendErc721Token(recipient: Go23Wallet.Address, account: Go23Wallet.Address) throws -> UnconfirmedTransaction {
        switch self {
    ...
    public func buildClaimPaidErc875MagicLink(recipient: Go23Wallet.Address, signedOrder: SignedOrder) throws -> UnconfirmedTransaction {
        guard case .prebuilt = self else { throw TransactionConfiguratorError.impossibleToBuildConfiguration }

        func encodeOrder(signedOrder: SignedOrder, recipient: Go23Wallet.Address) throws -> Data {
