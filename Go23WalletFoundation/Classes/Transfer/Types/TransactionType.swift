...
public enum TransactionType {
    ...
    public var contractForFungibleSend: DerbyWallet.Address? {
        switch self {
        case .nativeCryptocurrency:
            return nil
...
extension TransactionType {
    public enum Configuration {
        case tokenScriptTransaction(confirmType: ConfirmType, contract: DerbyWallet.Address, functionCallMetaData: DecodedFunctionCall)
