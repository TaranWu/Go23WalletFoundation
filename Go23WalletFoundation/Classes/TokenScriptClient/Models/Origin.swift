...
enum Origin {
    ...
    init?(forEthereumFunctionElement ethereumFunctionElement: XMLElement, root: XMLDocument, originContract: Go23Wallet.Address, xmlContext: XmlContext) {
    ...
    init?(forEthereumEventElement eventElementOrigin: XMLElement, asnModuleNamedTypeElement: XMLElement, contract: Go23Wallet.Address, xmlContext: XmlContext) {
