...
public enum OriginAsType: String {
    case address
    case uint
    case utf8
    case e18
...
enum Origin {
    ...
    init?(forEthereumFunctionElement ethereumFunctionElement: XMLElement, root: XMLDocument, attributeName: AttributeId, originContract: DerbyWallet.Address, xmlContext: XmlContext) {
    ...
    init?(forEthereumEventElement eventElementOrigin: XMLElement, asnModuleNamedTypeElement: XMLElement, contract: DerbyWallet.Address, xmlContext: XmlContext) {
