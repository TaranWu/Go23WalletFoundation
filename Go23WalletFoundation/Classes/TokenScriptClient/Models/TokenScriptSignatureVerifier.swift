...
public protocol TokenScriptStatusResolver {
    func computeTokenScriptStatus(forContract contract: Go23Wallet.Address, xmlString: String, isOfficial: Bool) -> Promise<TokenLevelTokenScriptDisplayStatus>
}
...
public final class TokenScriptSignatureVerifier: TokenScriptSignatureVerifieble {
    ...
    private let queue = DispatchQueue(label: "org.Go23Wallet.swift.TokenScriptSignatureVerifier")
