...
extension EventSource.Functional {
    ...
    private static func convertEventToDatabaseObject(_ event: Web3.EventParserResultProtocol, filterParam: [(filter: [Web3.EventFilterable], textEquivalent: String)?], eventOrigin: EventOrigin, contractAddress: DerbyWallet.Address, server: RPCServer) -> EventInstanceValue? {
