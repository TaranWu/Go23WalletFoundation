...
final class EventSource {
    ...
    class ChainTokenEventsForTickersWorker {
        ...
        private var workers: [Go23Wallet.Address: TokenEventsForTickersWorker] = [:]
        ...
        enum RequestOrCancellation {
            ...
            case cancel(contract: Go23Wallet.Address)
        }

        private func addOrFetchWorkers(requests: [FetchRequest]) -> [Go23Wallet.Address: TokenEventsForTickersWorker] {
            var workers: [Go23Wallet.Address: TokenEventsForTickersWorker] = [:]
...
extension EventSource.functional {
    ...
    static func convertEventToDatabaseObject(_ event: EventParserResultProtocol, filterParam: [(filter: [EventFilterable], textEquivalent: String)?], eventOrigin: EventOrigin, contractAddress: Go23Wallet.Address, server: RPCServer) -> EventInstanceValue? {
