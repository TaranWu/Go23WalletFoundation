...
public class NonFungibleJsonBalanceFetcher {
    ...
    public func fetchNonFungibleJson(forTokenId tokenId: String, tokenType: TokenType, address: DerbyWallet.Address, enjinTokens: EnjinTokenIdsToSemiFungibles) -> Guarantee<NonFungibleBalanceAndItsSource<JsonString>> {
        firstly {
    ...
    private func generateTokenJsonFallback(forTokenId tokenId: String, tokenType: TokenType, address: DerbyWallet.Address) -> Guarantee<NonFungibleBalanceAndItsSource<JsonString>> {
    ...
    private func fetchTokenJson(forTokenId tokenId: String, tokenType: TokenType, uri originalUri: URL, address: DerbyWallet.Address, enjinTokens: EnjinTokenIdsToSemiFungibles) -> Promise<NonFungibleBalanceAndItsSource<JsonString>> {
