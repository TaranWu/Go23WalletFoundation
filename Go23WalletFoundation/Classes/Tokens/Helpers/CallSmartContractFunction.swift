...
public func callSmartContract(withServer server: RPCServer, contract: DerbyWallet.Address, functionName: String, abiString: String, parameters: [AnyObject] = [], shouldDelayIfCached: Bool = false, queue: DispatchQueue? = nil) -> Promise<[String: Any]> {
...
public func getSmartContractCallData(withServer server: RPCServer, contract: DerbyWallet.Address, functionName: String, abiString: String, parameters: [AnyObject] = []) -> Data? {
...
func createSmartContractCallError(forContract contract: DerbyWallet.Address, functionName: String) -> Error {
