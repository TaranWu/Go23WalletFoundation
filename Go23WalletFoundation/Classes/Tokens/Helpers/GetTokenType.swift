...
final class GetTokenType {
    ...
    private let queue = DispatchQueue(label: "org.Go23Wallet.swift.getTokenType")
    ...
    private func getTokenType(for address: Go23Wallet.Address, completion: @escaping (TokenType) -> Void) {
        enum Erc721Type {
            case erc721
