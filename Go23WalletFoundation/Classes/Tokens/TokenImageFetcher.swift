...
public protocol TokenImageFetcher {
    func image(contractAddress: Go23Wallet.Address,
               server: RPCServer,
               name: String,
               type: TokenType,
...
public class TokenImageFetcherImpl: TokenImageFetcher {
    ...
    private static func programmaticallyGenerateIcon(for contractAddress: Go23Wallet.Address,
                                                     type: TokenType,
                                                     server: RPCServer,
                                                     symbol: String,
                                                     colors: [UIColor],
    ...
    public func image(contractAddress: Go23Wallet.Address,
                      server: RPCServer,
                      name: String,
                      type: TokenType,
                      balance: NonFungibleFromJson?,
    ...
    private func fetchFromAssetGitHubRepo(_ githubAssetsSource: GithubAssetsURLResolver.Source,
                                          contractAddress: Go23Wallet.Address) -> Promise<UIImage> {
...
private func programmaticallyGeneratedIconImage(for contractAddress: Go23Wallet.Address,
                                                server: RPCServer,
                                                colors: [UIColor],
...
private func symbolBackgroundColor(for contractAddress: Go23Wallet.Address,
                                   server: RPCServer,
                                   colors: [UIColor],
