...
public class Go23WalletTokensService: TokensService {
    ...
    public lazy var tokensPublisher: AnyPublisher<[Token], Never> = {
        providers.map { $0.values }
            ...
            }.map { Go23WalletTokensService.filterAwaySpuriousTokens($0) }
            .eraseToAnyPublisher()
    }()
    ...
    public var tokens: [Token] {
        Go23WalletTokensService.filterAwaySpuriousTokens(providers.value.flatMap { $0.value.tokens })
    }
...
extension Go23WalletTokensService: TokensServiceTests {
...
extension Go23WalletTokensService {
