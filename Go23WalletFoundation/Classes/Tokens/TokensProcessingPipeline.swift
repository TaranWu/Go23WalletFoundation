...
public protocol TokenViewModelState {
    ...
    func tokenViewModelPublisher(for contract: DerbyWallet.Address, server: RPCServer) -> AnyPublisher<TokenViewModel?, Never>
    func tokenViewModel(for contract: DerbyWallet.Address, server: RPCServer) -> TokenViewModel?
}
...
public final class WalletDataProcessingPipeline: TokensProcessingPipeline {
    ...
    private let queue = DispatchQueue(label: "org.DerbyWallet.swift.walletData.processingPipeline", qos: .utility)
    ...
    public func tokenViewModel(for contract: DerbyWallet.Address, server: RPCServer) -> TokenViewModel? {
    ...
    public func tokenViewModelPublisher(for contract: DerbyWallet.Address, server: RPCServer) -> AnyPublisher<TokenViewModel?, Never> {
