...
public class SignatureHelper {
    class func signatureAsHex(for message: String, account: Go23Wallet.Address, keystore: Keystore, prompt: String) async throws -> String? {
    ...
    public class func signatureAsDecimal(for message: String, account: Go23Wallet.Address, keystore: Keystore, prompt: String) async throws -> String? {
