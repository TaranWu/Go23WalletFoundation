...
public class OrderHandler {
    ...
    public func signOrders(orders: [Order], account: Go23Wallet.Address, tokenType: TokenType) throws -> [SignedOrder] {
    ...
    private func bulkSignOrders(messages: [Data], account: Go23Wallet.Address, orders: [Order]) throws -> [SignedOrder] {
