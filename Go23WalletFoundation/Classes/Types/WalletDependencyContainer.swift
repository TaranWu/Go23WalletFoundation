...
public class WalletComponentsFactory: WalletDependencyContainer {
    ...
    public func makeDependencies(for wallet: Wallet) -> WalletDependency {
        ...
        let tokensService = DerbyWalletTokensService(sessionsProvider: sessionsProvider, tokensDataStore: tokensDataStore, analytics: analytics, importToken: importToken, transactionsStorage: transactionsDataStore, nftProvider: nftProvider, assetDefinitionStore: assetDefinitionStore)
