...
extension Covalent {
    ...
    struct BalancesResponse {
        ...
        init(json: JSON) throws {
            guard
                let address = DerbyWallet.Address(string: json["address"].stringValue),
                let chainId = json["chain_id"].int,
                let quoteCurrency = json["quote_currency"].string,
                let items = json["items"].array else {
                throw DecodyingError.fieldMismatch
        ...
        struct NFTAsset {
            ...
            let originalOwner: DerbyWallet.Address
            let owner: DerbyWallet.Address

            init(json: JSON) throws {
                guard
                    let originalOwner = DerbyWallet.Address(string: json["original_owner"].stringValue),
                    let owner = DerbyWallet.Address(string: json["owner_address"].stringValue),
        ...
        struct Token {
            ...
            init(json: JSON) throws {
                guard
                    let address = DerbyWallet.Address(string: json["contract_address"].stringValue),
