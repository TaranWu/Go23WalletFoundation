...
public extension Covalent {
    ...
    public final class NetworkProvider {
        ...
        func transactions(walletAddress: DerbyWallet.Address, server: RPCServer, page: Int? = nil, pageSize: Int = 5, blockSignedAtAsc: Bool = false) -> AnyPublisher<TransactionsResponse, CovalentError> {
            return Alamofire
        ...
        func balances(walletAddress: DerbyWallet.Address, server: RPCServer, quoteCurrency: String, nft: Bool, noNftFetch: Bool) -> AnyPublisher<BalancesResponse, CovalentError> {
            return Alamofire
