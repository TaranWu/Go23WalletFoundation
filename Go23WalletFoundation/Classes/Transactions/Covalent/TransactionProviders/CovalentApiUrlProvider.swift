...
extension Covalent {
    enum ApiUrlProvider: URLConvertible {
        case transactions(walletAddress: DerbyWallet.Address, server: RPCServer, page: Int?, pageSize: Int, apiKey: String, blockSignedAtAsc: Bool)
        case balances(walletAddress: DerbyWallet.Address, server: RPCServer, quoteCurrency: String, nft: Bool, noNftFetch: Bool, apiKey: String)
