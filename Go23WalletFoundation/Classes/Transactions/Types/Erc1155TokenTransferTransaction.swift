//
//  Erc1155TokenTransferTransaction.swift
...
struct Erc1155TokenTransferTransaction {
    let hash: String
...
extension Erc1155TokenTransferTransaction: Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        self.tokenId = try container.decode(String.self, forKey: .tokenId, defaultValue: "")
        self.tokenValue = try container.decode(String.self, forKey: .tokenValue, defaultValue: "")
    }
}
