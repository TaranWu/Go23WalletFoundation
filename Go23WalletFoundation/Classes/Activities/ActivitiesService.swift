...
typealias ContractsAndCards = [(contract: Go23Wallet.Address, server: RPCServer, card: TokenScriptCard, interpolatedFilter: String)]
typealias ActivityTokenObjectTokenHolder = (activity: Activity, tokenObject: Token, tokenHolder: TokenHolder)
typealias TokenObjectsAndXMLHandlers = [(contract: Go23Wallet.Address, server: RPCServer, xmlHandler: XMLHandler)]
...
extension ActivitiesService.functional {
    static func generateImplicitAttributesForCard(forContract contract: Go23Wallet.Address, server: RPCServer, event: EventActivityInstance) -> [String: AssetInternalValue] {
