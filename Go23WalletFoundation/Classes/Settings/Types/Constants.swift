...
public struct Constants {
    ...
    public static let nullAddress = Go23Wallet.Address(uncheckedAgainstNullAddress: "0x0000000000000000000000000000000000000000")!
    public static let nativeCryptoAddressInDatabase = nullAddress

    // FIFA hardcoded FIFA token address
    public static let ticketContractAddress = Go23Wallet.Address(string: "0xA66A3F08068174e8F005112A8b2c7A507a822335")!
    static let ticketContractAddressRopsten = Go23Wallet.Address(string: "0xD8e5F58DE3933E1E35f9c65eb72cb188674624F3")!

    // UEFA hardcoded addresses
    static let uefaMainnet = (Go23Wallet.Address(string: "0x89D142Bef8605646881C68dcD48cDAF17FE597dC")!, RPCServer.main)
    static let gnoGnosis = (Go23Wallet.Address(string: "0x9c58bacc331c9aa871afd802db6379a98e80cedb")!, RPCServer.xDai)
    ...
    public static let katNameFallback = "Go23Wallet.katNameFallback"
    ...
    static let legacy875Addresses = [Go23Wallet.Address(string: "0x830e1650a87a754e37ca7ed76b700395a7c61614")!,
                                            Go23Wallet.Address(string: "0xa66a3f08068174e8f005112a8b2c7a507a822335")!]
    static let legacy721Addresses = [
        Go23Wallet.Address(string: "0x06012c8cf97bead5deae237070f9587f8e7a266d")!,
        Go23Wallet.Address(string: "0xabc7e6c01237e8eef355bba2bf925a730b714d5f")!,
        Go23Wallet.Address(string: "0x71c118b00759b0851785642541ceb0f4ceea0bd5")!,
        Go23Wallet.Address(string: "0x7fdcd2a1e52f10c28cb7732f46393e297ecadda1")!
    ]

    static let ensContractOnMainnet = Go23Wallet.Address.ethereumAddress(eip55String: "0x57f1887a8BF19b14fC0dF6Fd9B2acc9Af147eA85")
