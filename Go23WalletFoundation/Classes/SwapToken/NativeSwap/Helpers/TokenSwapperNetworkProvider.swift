...
public protocol TokenSwapperNetworkProvider {
    ...
    func fetchSwapQuote(fromToken: TokenToSwap, toToken: TokenToSwap, wallet: DerbyWallet.Address, slippage: String, fromAmount: BigUInt) -> AnyPublisher<SwapQuote, SwapError>
}
...
public final class LiQuestTokenSwapperNetworkProvider: TokenSwapperNetworkProvider {
    ...
    public func fetchSwapQuote(fromToken: TokenToSwap, toToken: TokenToSwap, wallet: DerbyWallet.Address, slippage: String, fromAmount: BigUInt) -> AnyPublisher<SwapQuote, SwapError> {
        let parameters: [String: Any] = [
