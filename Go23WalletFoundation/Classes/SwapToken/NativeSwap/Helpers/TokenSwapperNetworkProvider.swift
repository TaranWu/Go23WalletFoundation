...
public protocol TokenSwapperNetworkProvider {
    ...
    func fetchSwapQuote(fromToken: TokenToSwap, toToken: TokenToSwap, wallet: Go23Wallet.Address, slippage: String, fromAmount: BigUInt, exchange: String) -> AnyPublisher<SwapQuote, SwapError>
}
...
public final class LiQuestTokenSwapperNetworkProvider: TokenSwapperNetworkProvider {
    ...
    public func fetchSwapQuote(fromToken: TokenToSwap, toToken: TokenToSwap, wallet: Go23Wallet.Address, slippage: String, fromAmount: BigUInt, exchange: String) -> AnyPublisher<SwapQuote, SwapError> {
        return networkService
